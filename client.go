...
// Client is a client for the Banano RPC protocol,
...
// Send sends a raw amount of Banano to a wallet,
...
func (c *Client) ChangeRepresentative(representative, seed string, index int) (string, error) {
	...
	block := Block{
		...
		LinkAsAccount:  "ban_1111111111111111111111111111111111111111111111111111hifc8npp",
	}
